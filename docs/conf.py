...
def linkcode_resolve(domain, info):
    ...
    def str_from(string, start="gbif-dl"):
    ...
    base_url = f"https://github.com/plantnet/gbif-dl/blob/{tag}/%s"
...
man_pages = [(master_doc, "gbif-dl", "gbif-dl Documentation", [author], 1)]
